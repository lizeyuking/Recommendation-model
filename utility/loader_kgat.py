...
class KGAT_loader(Data):
    def __init__(self, args, path):
        ...
        # 生成三元组字典，键是'head'，值是'(tail, relation)'。
    ...
    def _get_relational_adj_list(self): #实现CF稀疏矩阵的存储和KG在r关系下稀疏矩阵的存储。
        t1 = time()
        adj_mat_list = []
        adj_r_list = []
        ...
        for r_id in self.relation_dict.keys():  ## KG在特定关系r下的稀疏矩阵
    ...
    def _get_relational_lap_list(self):   #实现了归一化
